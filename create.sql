...
CREATE TABLE TimeStampp (
    time_acc TIME NOT NULL REFERENCES TimeAcc(time_acc),
    date_acc DATE NOT NULL REFERENCES DateAcc(date_acc),
...
CREATE TABLE Accident (
    ...
    TimeStamp_id INT NOT NULL REFERENCES TimeStampp(TimeStamp_id),
